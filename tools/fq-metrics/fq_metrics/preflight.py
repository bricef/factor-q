...
FQ_FIX = (
    ...
    "  The edge is published on the host's reachable address too (FQ_EDGE_ADDR in\n"
    "  the stack's .env), so pair straight to it:\n"
    "    fq connect <guest-address>:9470 --token <the output> --fingerprint <the fingerprint>\n"
